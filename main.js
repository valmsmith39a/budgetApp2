...
function init(){
	...
	// $('.old-transactions').on('click', deleteEntryButton);
}
...
function deleteEntryButton(){
	...
	// console.log('array of row objects before delete', arrayOfRowObjectsG);
	...
	// console.log('array of row objects', arrayOfRowObjectsG);
}
